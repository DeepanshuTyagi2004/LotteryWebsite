...
export function Footer() {
  return (
    <div className="flex flex-col items-center justify-center gap-[3vw] -mt-[20vw]">
      ...
      />
      <div className="flex flex-col items-start justify-center gap-[3vw] w-full max-w-[75vw] text-[#CB0000]">
        <p className="text-[0.8vw] max-w-full">
      ...
      <div className="bg-footer bg-no-repeat bg-cover w-full h-[40vw] flex flex-col items-center justify-center gap-[3vw]">
        <p className="text-[1.8vw] max-w-full text-[#793300] font-bold">Menu</p>
        <div className="flex flex-row justify-evenly gap-[5vw] w-full max-w-[75vw] items-baseline">
          <div className="flex flex-col items-start justify-center">
            <p className="text-[1.2vw] max-w-full text-[#793300] font-bold">
              PRODUCTS
            </p>
            <p className="text-[1.2vw] max-w-full text-[#793300] mt-[2vw]">
              All games
            </p>
            <p className="text-[1.2vw] max-w-full text-[#793300]">
              High-frequency games
            </p>
            <p className="text-[1.2vw] lg:max-w-full text-[#793300]">
              Lottery games
            </p>
            <p className="text-[1.2vw] lg:max-w-full text-[#793300]">
              Arrangement games
          ...
          <div className="flex flex-col items-start justify-center">
            ...
            <p className="text-[1.2vw] max-w-full text-[#793300]">news</p>
            <p className="text-[1.2vw] max-w-full text-[#793300]">
              public welfare
            </p>
            <p className="text-[1.2vw] max-w-full text-[#793300]">
        ...
        <div className="flex flex-row items-center justify-end w-full max-w-[75vw]">
          <img
            src={PlayStore}
            alt="PlayStore"
            className=" cursor-pointer w-[8vw]"
          />
          <img
            src={AppStore}
            alt="AppStore"
        ...
        <div className="flex flex-row items-center justify-between w-full max-w-[75vw] -mt-[2vw] flex-wrap">
          <p className="text-[0.8vw] max-w-full text-[#ffffff]">
